package com.app.nestedlist.adapter
...
import com.app.nestedlist.logic.ExpandReducer
import com.app.nestedlist.logic.FoldReducer
import com.app.nestedlist.logic.LoadLv1Reducer
import com.app.nestedlist.logic.Reducer
import com.app.nestedlist.logic.ReplyReducer
import com.app.nestedlist.logic.StartExpandReducer
import com.app.nestedlist.logic.StartLoadLv1Reducer
import kotlinx.coroutines.delay

class CommentAdapter(private val reduceBlock: Reducer.() -> Unit) :
    ListAdapter<CommentItem, VH>(object :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): VH {
        ...
        return when (viewType) {
            ...
            TYPE_LOADING -> LoadingVH(
                inflater.inflate(R.layout.item_comment_loading, parent, false),
                reduceBlock
            )
    ...
    override fun getItemViewType(position: Int): Int {
        return when (getItem(position)) {
            ...
            is CommentItem.Folding -> TYPE_FOLDING
            else -> TYPE_LOADING
        }
    }
